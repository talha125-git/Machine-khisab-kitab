        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6 shadow-2xl shadow-slate-300/50">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              onClick={onConfirm}
              className="flex-1 rounded-lg bg-gradient-to-r from-red-500 to-red-600 px-4 py-2.5 text-sm font-semibold text-white shadow-md shadow-red-500/20 transition-all hover:from-red-600 hover:to-red-700 hover:shadow-red-500/30 cursor-pointer"
            >
              Yes, Delete
            </button>
          </div>
